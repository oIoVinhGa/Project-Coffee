	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<div class="container">
				...
				<form:form action="/admin/category/create" modelAttribute="item"
					method="post">
					...
					<hr>
					<button class="btn btn-secondary" formaction="/admin/category/create"
						type="submit">Create</button>
					<button class="btn btn-success" formaction="/admin/category/update"
						type="submit">Update</button>
					<button class="btn btn-primary" formaction="/admin/category/index"
					...
					<tbody>
						<c:forEach var="p" items="${items}">
							<tr>
								<td>${p.id}</td>
								<td>${p.name}</td>
								<td><a href="/admin/category/delete?id=${p.id}"><i
										class="bi bi-trash text-danger"></i></a> <a
									href="/admin/category/edit/${p.id}"><i
